...
eu_company_freq <- eu_orphan_drugs %>%
  count(firm) %>%
  arrange(desc(n))
colnames(eu_company_freq) <- c("Firm", "Market Authorization Frequency")
eu_company_freq
```
...
Number of MAs per company in US
...
Number of designations per product in US
...
us_od_ma_freqs_post2003 <- us_od_ma_freqs[us_od_ma_freqs$Year > 2003,]
ggplot(us_od_ma_freqs_post2003, aes(x = Year)) +
  geom_line(aes(y = `Freq Orphan Drug MAs`, color="All Orphan Drug MAs")) +
  geom_line(aes(y = `Freq New Orphan Drug MAs`, color="MAs for New Orphan Drugs")) +
  labs(x = "Year",
...
```{r}
ggplot(combined_rd_ma_df, aes(x = freq_orphan_drug_mas, y = annual_domestic_RD_spending_bil_dollars, color = area)) +
  geom_point() +
  labs(x = "Domestic R&D Spending",
       y = "Number of Orphan Drug MAs",
       color = "Region",
       title="Orphan Drug MAs by Domestic R&D Spending in the EU and US") +
    scale_color_manual(name = "Region", values = c('US' = 'darkblue', 'EU' = '#E66100')) +
  theme_minimal()
```

```{r}
ggplot(combined_rd_ma_df, aes(x = freq_new_orphan_drug_mas, y = annual_domestic_RD_spending_bil_dollars, color = area)) +
  geom_point() +
  labs(x = "Domestic R&D Spending",
...
```{r}
mod.rd.3 <- lm(annual_domestic_RD_spending_bil_dollars ~  as.factor(area) + gdp_per_capita_annual_growthrate_usd +  gdp_billions_of_usd + yearsafter2004, data=combined_rd_ma_df)
summary(mod.rd.3)
...
```{r}
mod.rd.5 <- lm(annual_domestic_RD_spending_bil_dollars ~  as.factor(area) + gdp_per_capita_annual_growthrate_usd + gdp_billions_of_usd + yearsafter2004 + yearsafter2004:as.factor(area), data=combined_rd_ma_df)
summary(mod.rd.5)
...
```{r}
mod.rd.6 <- lm(annual_domestic_RD_spending_bil_dollars ~  as.factor(area) + gdp_per_capita_annual_growthrate_usd + gdp_billions_of_usd + yearsafter2004 + yearsafter2004:as.factor(area) +  +I(yearsafter2004^2) + I(yearsafter2004^2):as.factor(area), data=combined_rd_ma_df)
summary(mod.rd.6)
...
stargazer(mod.rd.1, mod.rd.2, mod.rd.3, mod.rd.4, mod.rd.5, mod.rd.6, 
          title="Linear Models of Annual Domestic Pharmaceutical R&D Spending (Not Adjusted for Error Structure)", align=TRUE, type = "html", out="Final Models Formatted/Adjusted R&D Models/rdmodelsNonAdjusted.htm",
          covariate.labels = c("US", "Annual GDP Growth Rate Per Capita", "GDP (billions USD)", "Years After 2004", "Years After 2004^{2})", "US:Years After 2004", "US:Years After 2004^{2}", "Intercept"),
...
stargazer(m1, m2, m3, m4, m5, m6, title="Newey-West Adjusted Linear Models of Annual Domestic Pharmaceutical R&D Spending", align=TRUE, type = "html", out="Final Models Formatted/Adjusted R&D Models/rdmodels.htm",
          covariate.labels = c("US", "Annual GDP Growth Rate Per Capita", "GDP (billions USD)", "Years After 2004", "Years After 2004^{2}", "US:Years After 2004", "US:Years After 2004^{2}", "Intercept"),
          dep.var.labels=c("Annual Domestic Pharmaceutical R&D Spending (Billion USD)"),
          column.labels=c("Model 1", "Model 2", "Model 3", "Model 4", "Model 5", "Model 6"),
          omit.stat = c("all"),
...
# New LM of Annual orphan drug MAS

## Linear Model 1 of Num of Annual Orphan Drug MAs

```{r}
mod.od.1 <- lm(freq_orphan_drug_mas ~ as.factor(area) + yearsafter2004 + gdp_per_capita_annual_growthrate_usd + gdp_billions_of_usd, data=combined_rd_ma_df)
summary(mod.od.1)
...
```{r}
mod.od.2 <- lm(freq_orphan_drug_mas ~ yearsafter2004 + annual_domestic_RD_spending_bil_dollars + gdp_per_capita_annual_growthrate_usd + gdp_billions_of_usd, data=combined_rd_ma_df)
summary(mod.od.2)
...
```{r}
mod.od.3 <- lm(freq_orphan_drug_mas ~ as.factor(area) + yearsafter2004 + annual_domestic_RD_spending_bil_dollars + gdp_per_capita_annual_growthrate_usd + gdp_billions_of_usd, data=combined_rd_ma_df)
summary(mod.od.3)
...
```{r}
mod.od.4 <- lm(freq_orphan_drug_mas ~ yearsafter2004 + annual_domestic_RD_spending_bil_dollars + gdp_per_capita_annual_growthrate_usd + gdp_billions_of_usd+ annual_domestic_RD_spending_bil_dollars:yearsafter2004, data=combined_rd_ma_df)
summary(mod.od.4)
...
ggplot(combined_rd_ma_df, aes(x = annual_domestic_RD_spending_bil_dollars, y = freq_orphan_drug_mas, color = area, alpha="Observed")) +
  geom_point() +
  labs(x = "Domestic R&D Spending (Billion USD)",
       y = str_wrap("Number of Orphan Drug Market Authorizations", width = 40),
       color = "Region",
       alpha = "",
       title=str_wrap(glue("Linear Model 5 of Orphan Drug Market Authorizations by Domestic R&D Spending"), width = 60))+
  scale_color_manual(name = "Region", values = c('US' = 'darkblue', 'EU' = '#E66100')) +
...
```{r}
mod.od.5 <- lm(freq_orphan_drug_mas ~ as.factor(area) + yearsafter2004 + gdp_per_capita_annual_growthrate_usd + gdp_billions_of_usd + as.factor(area):yearsafter2004, data=combined_rd_ma_df)
summary(mod.od.5)
...
stargazer(mod.od.1, mod.od.2, mod.od.3, mod.od.4, mod.od.5, title="Linear Models of Orphan Drug Market Authorizations (Not Adjusted for Error Structure)", align=TRUE, type = "html", out="Final Models Formatted/Adjusted R&D Models/orphandrugMAmodelsNonAdjusted.htm",
          covariate.labels = c("US", "Years After 2004", "Annual Domestic R&D Spending (Billions USD)", "Annual GDP Growth Rate Per Capita", "GDP (Billions USD)", "Years After 2004:Annual Domestic R&D Spending (Billions USD)", "Years After 2004:US" ,"Intercept"),
...
stargazer(m1,m2,m3,m4,m5, title="Newey-West Adjusted Linear Models of Orphan Drug Market Authorizations", align=TRUE, type = "html", out="Final Models Formatted/Adjusted R&D Models/orphandrugMAmodels.htm",
          covariate.labels = c("US", "Years After 2004", "Annual Domestic R&D Spending (Billions USD)", "Annual GDP Growth Rate Per Capita", "GDP (Billions USD)", "Years After 2004:Annual Domestic R&D Spending (Billions USD)", "Years After 2004:US" ,"Intercept"),
          dep.var.labels=c("Annual Number of Market Authorized Orphan Drugs"),
          column.labels=c("Model 1", "Model 2", "Model 3", "Model 4", "Model 5"),
          model.numbers=FALSE,
...
```{r}
mod.pois.od.1 <- glm(freq_orphan_drug_mas ~ as.factor(area) + yearsafter2004 + gdp_per_capita_annual_growthrate_usd + gdp_billions_of_usd, data=combined_rd_ma_df, family=poisson(link="log"))
...
```{r}
mod.pois.od.2 <- glm(freq_orphan_drug_mas ~ yearsafter2004 + annual_domestic_RD_spending_bil_dollars + gdp_per_capita_annual_growthrate_usd + gdp_billions_of_usd, data=combined_rd_ma_df, family=poisson(link="log"))
...
```{r}
mod.pois.od.3 <- glm(freq_orphan_drug_mas ~ as.factor(area) + yearsafter2004 + annual_domestic_RD_spending_bil_dollars + gdp_per_capita_annual_growthrate_usd + gdp_billions_of_usd, data=combined_rd_ma_df, family=poisson(link="log"))
...
```{r}
mod.pois.od.4 <- glm(freq_orphan_drug_mas ~ yearsafter2004 + annual_domestic_RD_spending_bil_dollars + gdp_per_capita_annual_growthrate_usd + gdp_billions_of_usd + annual_domestic_RD_spending_bil_dollars:yearsafter2004, data=combined_rd_ma_df, family=poisson(link="log"))
...
```{r}
mod.pois.od.5 <- glm(freq_orphan_drug_mas ~ as.factor(area) + yearsafter2004 + gdp_per_capita_annual_growthrate_usd + gdp_billions_of_usd + as.factor(area):yearsafter2004, data=combined_rd_ma_df, family=poisson(link="log")) 
...
stargazer(m1, m2, m3, m4, m5, title="Poisson Models of Annual Orphan Drug Market Authorizations (Not adjusted for Error Structure)", align=TRUE, type = "html", out="Final Models Formatted/Adjusted R&D Models/PoissonorphandrugMAmodelsNonAdjusted.htm",
          covariate.labels = c("US", "Years After 2004", "Annual Domestic R&D Spending (Billions USD)", "Annual GDP Growth Rate Per Capita", "GDP (Billions USD)", "Years After 2004:Annual Domestic R&D Spending (Billions USD)", "Years After 2004:US" ,"Intercept"),
...
stargazer(m1,m2,m3,m4,m5, title="Newey-West Adjusted Poisson Models of Orphan Drug Market Authorizations", align=TRUE, type = "html", out="Final Models Formatted/Adjusted R&D Models/PoissonorphandrugMAmodels.htm",
          covariate.labels = c("US", "Years After 2004", "Annual Domestic R&D Spending (Billions USD)", "Annual GDP Growth Rate Per Capita", "GDP (Billions USD)", "Years After 2004:Annual Domestic R&D Spending (Billions USD)", "Years After 2004:US" ,"Intercept"),
          dep.var.labels=c("Annual Number of Orphan Drug Market Authorizations"),
          column.labels=c("Model 1", "Model 2", "Model 3", "Model 4", "Model 5"),
          model.numbers=FALSE,
...
```{r}
mod.new.od.1 <- lm(freq_new_orphan_drug_mas ~ as.factor(area) + yearsafter2004 + gdp_per_capita_annual_growthrate_usd, data=combined_rd_ma_df)
...
```{r}
mod.new.od.2 <- lm(freq_new_orphan_drug_mas ~ yearsafter2004 + annual_domestic_RD_spending_bil_dollars + gdp_per_capita_annual_growthrate_usd, data=combined_rd_ma_df)
...
```{r}
mod.new.od.3 <- lm(freq_new_orphan_drug_mas ~ as.factor(area) + yearsafter2004 + annual_domestic_RD_spending_bil_dollars + gdp_per_capita_annual_growthrate_usd, data=combined_rd_ma_df)
...
```{r}
mod.new.od.4 <- lm(freq_new_orphan_drug_mas ~ yearsafter2004 + annual_domestic_RD_spending_bil_dollars + gdp_per_capita_annual_growthrate_usd + annual_domestic_RD_spending_bil_dollars:yearsafter2004, data=combined_rd_ma_df)
...
```{r}
mod.new.od.5 <- lm(freq_new_orphan_drug_mas ~  as.factor(area) + yearsafter2004 + gdp_per_capita_annual_growthrate_usd + as.factor(area):yearsafter2004, data=combined_rd_ma_df)
...
stargazer(m1, m2, m3, m4, m5, title="Linear Models of Market Authorizations for New Orphan Drugs (Not adjusted for Error Structure)", align=TRUE, type = "html", out="Final Models Formatted/NEWorphandrugMAmodelsNonAdjusted.htm",
          covariate.labels = c("US", "Years After 2004", "Annual Domestic R&D Spending (Billions USD)", "Annual GDP Growth Rate Per Capita", "Years After 2004:US", "Annual Domestic R&D Spending (Billions USD):US", "Intercept"),
...
```{r}
mod.pois.new.od.1 <- glm(freq_new_orphan_drug_mas ~ as.factor(area) + yearsafter2004 + gdp_per_capita_annual_growthrate_usd, data=combined_rd_ma_df, family=poisson(link="log"))
...
```{r}
mod.pois.new.od.2 <- glm(freq_new_orphan_drug_mas ~ yearsafter2004 + annual_domestic_RD_spending_bil_dollars + gdp_per_capita_annual_growthrate_usd, data=combined_rd_ma_df, family=poisson(link="log"))
...
```{r}
mod.pois.new.od.3 <- glm(freq_new_orphan_drug_mas ~ as.factor(area) + yearsafter2004 + annual_domestic_RD_spending_bil_dollars + gdp_per_capita_annual_growthrate_usd, data=combined_rd_ma_df, family=poisson(link="log"))
...
```{r}
mod.pois.new.od.4 <- glm(freq_new_orphan_drug_mas ~ yearsafter2004 + annual_domestic_RD_spending_bil_dollars + gdp_per_capita_annual_growthrate_usd + annual_domestic_RD_spending_bil_dollars:yearsafter2004, data=combined_rd_ma_df, family=poisson(link="log")) 
...
```{r}
mod.pois.new.od.5 <- glm(freq_new_orphan_drug_mas ~ as.factor(area) + yearsafter2004 + gdp_per_capita_annual_growthrate_usd + as.factor(area):yearsafter2004, data=combined_rd_ma_df, family=poisson(link="log")) 
