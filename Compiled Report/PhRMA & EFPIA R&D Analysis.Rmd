...
```{r}
phrma_us_rd <- read.csv("/Users/benasmith/Desktop/Research Proj/Pharma Proj/Compiled Report/Cleaned Data/Area Level R&D Spending/US Domestic R&D and R&D Abroad,* PhRMA Member Companies- 1983–2021 (dollar figures in millions) .csv")
head(phrma_us_rd)
```
...
```{r}
us_orphan_drugs <- read.csv("~/Desktop/Research Proj/Pharma Proj/Compiled Report/Original Data/Area Level Orphan Authorizations/US_FDA_OD.csv")
...
```{r}
eu_gdp_percapita_annual <- read.csv("/Users/benasmith/Desktop/Research Proj/Pharma Proj/Compiled Report/Original Data/GDP/european-union-gdp-per-capita-annual.csv", skip=16)
...
```{r}
eu_gdp_growth_rate_annual <- read.csv("/Users/benasmith/Desktop/Research Proj/Pharma Proj/Compiled Report/Original Data/GDP/european-union-gdp-growth-rate.csv", skip=16)
...
```{r}
us_gdp_percapita_annual <- read.csv("/Users/benasmith/Desktop/Research Proj/Pharma Proj/Compiled Report/Original Data/GDP/united-states-gdp-per-capita-annual.csv", skip=16)
...
```{r}
us_gdp_growth_rate_annual <- read.csv("/Users/benasmith/Desktop/Research Proj/Pharma Proj/Compiled Report/Original Data/GDP/united-states-gdp-growth-rate.csv", skip=16)
...
mod.od.nw.1 <- coeftest(mod.od.1, vcov = mod.od.1.vcov) # vcov = NeweyWest(mod.od.1, lag = 1, prewhite = FALSE))
mod.od.nw.1

mod.od.nw.1.test <- coeftest(mod.od.1, , vcov = NeweyWest(mod.od.1, lag = 1, prewhite = FALSE))
mod.od.nw.1.test
...
mod.new.od.nw.1 <- coeftest(mod.new.od.1, vcov = NeweyWest(mod.new.od.1, lag = 1, prewhite = FALSE))
mod.new.od.nw.1
...
mod.new.od.nw.2 <- coeftest(mod.new.od.2, vcov = NeweyWest(mod.new.od.2, lag = 1, prewhite = FALSE))
mod.new.od.nw.2
...
mod.new.od.nw.3 <-coeftest(mod.new.od.3, vcov = NeweyWest(mod.new.od.3, lag = 1, prewhite = FALSE))
mod.new.od.nw.3
...
mod.new.od.nw.4 <-coeftest(mod.new.od.4, vcov = NeweyWest(mod.new.od.4, lag = 1, prewhite = FALSE))
mod.new.od.nw.4
...
mod.new.od.nw.5 <-coeftest(mod.new.od.5, vcov = NeweyWest(mod.new.od.5, lag = 1, prewhite = FALSE))
mod.new.od.nw.5
...
mod.new.od.nw.6 <- coeftest(mod.new.od.6, vcov = NeweyWest(mod.new.od.6, lag = 1 , prewhite = FALSE))
mod.new.od.nw.6
...
mod.pois.od.nw.1 <- coeftest(mod.pois.od.1, vcov = NeweyWest(mod.pois.od.1, lag = 1, prewhite = FALSE))
mod.pois.od.nw.1
...
mod.pois.od.nw.2 <- coeftest(mod.pois.od.2, vcov = NeweyWest(mod.pois.od.2, lag = 1, prewhite = FALSE))
mod.pois.od.nw.2
...
mod.pois.od.nw.3 <-coeftest(mod.pois.od.3, vcov = NeweyWest(mod.pois.od.3, lag = 1, prewhite = FALSE))
mod.pois.od.nw.3
...
mod.pois.od.nw.4 <-coeftest(mod.pois.od.4, vcov = NeweyWest(mod.pois.od.4, lag = 1, prewhite = FALSE))
mod.pois.od.nw.4
...
mod.pois.od.nw.5 <-coeftest(mod.pois.od.5, vcov = NeweyWest(mod.pois.od.5, lag = 1, prewhite = FALSE))
mod.pois.od.nw.5
...
mod.pois.od.nw.6 <- coeftest(mod.pois.od.6, vcov = NeweyWest(mod.pois.od.6, lag = 1 , prewhite = FALSE))
mod.pois.od.nw.6
...
mod.pois.new.od.nw.1 <- coeftest(mod.pois.new.od.1, vcov = NeweyWest(mod.pois.new.od.1, lag = 1, prewhite = FALSE))
...
mod.pois.new.od.nw.2 <- coeftest(mod.pois.new.od.2, vcov = NeweyWest(mod.pois.new.od.2, lag = 1, prewhite = FALSE))
...
mod.pois.new.od.nw.3 <-coeftest(mod.pois.new.od.3, vcov = NeweyWest(mod.pois.new.od.3, lag = 1, prewhite = FALSE))
...
mod.pois.new.od.nw.4 <-coeftest(mod.pois.new.od.4, vcov = NeweyWest(mod.pois.new.od.4, lag = 1, prewhite = FALSE))
...
mod.pois.new.od.nw.5 <-coeftest(mod.pois.new.od.5, vcov = NeweyWest(mod.pois.new.od.5, lag = 1, prewhite = FALSE))
...
mod.pois.new.od.nw.6 <- coeftest(mod.pois.new.od.6, vcov = NeweyWest(mod.pois.new.od.6, lag = 1 , prewhite = FALSE))
...
```{r}
kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_new_orphan_drug_mas))
kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_new_orphan_drug_mas))

kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_orphan_drug_mas))
kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_orphan_drug_mas))

kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$annual_domestic_RD_spending_bil_dollars))
kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$annual_domestic_RD_spending_bil_dollars))

```

```{r}
adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_new_orphan_drug_mas))
adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_new_orphan_drug_mas))

adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_orphan_drug_mas))
adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_orphan_drug_mas))

adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$annual_domestic_RD_spending_bil_dollars))
adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$annual_domestic_RD_spending_bil_dollars))
...
```{r}
kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_new_orphan_drug_mas,differences = 2))
kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_new_orphan_drug_mas,differences = 2))

kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_orphan_drug_mas,differences = 2))
kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_orphan_drug_mas,differences = 2))

kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$annual_domestic_RD_spending_bil_dollars,differences = 2))
kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$annual_domestic_RD_spending_bil_dollars,differences = 2))

```

```{r}
adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_new_orphan_drug_mas, differences = 2))
adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_new_orphan_drug_mas, differences = 2))

adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_orphan_drug_mas, differences = 2))
adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_orphan_drug_mas, differences = 2))

adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$annual_domestic_RD_spending_bil_dollars, differences = 2))
adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$annual_domestic_RD_spending_bil_dollars, differences = 2))
...
```{r}
kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_new_orphan_drug_mas,differences = 3))
kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_new_orphan_drug_mas,differences = 3))

kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_orphan_drug_mas,differences = 3))
kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_orphan_drug_mas,differences = 3))

kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$annual_domestic_RD_spending_bil_dollars,differences = 3))
kpss.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$annual_domestic_RD_spending_bil_dollars,differences = 3))

```

```{r}
adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_new_orphan_drug_mas, differences = 3))
adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_new_orphan_drug_mas, differences = 3))

adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_orphan_drug_mas, differences = 3))
adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_orphan_drug_mas, differences = 3))

adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$annual_domestic_RD_spending_bil_dollars, differences = 3))
adf.test(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$annual_domestic_RD_spending_bil_dollars, differences = 3))
...
```{r}
plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_new_orphan_drug_mas, differences = 1), type="l")
plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_new_orphan_drug_mas, differences = 1), type="l")

plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_orphan_drug_mas, differences = 1), type="l")
plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_orphan_drug_mas, differences = 1), type="l")

plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$annual_domestic_RD_spending_bil_dollars, differences = 1), type="l")
plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$annual_domestic_RD_spending_bil_dollars, differences = 1), type="l")
...
```{r}
plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_new_orphan_drug_mas, differences = 2), type="l")
plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_new_orphan_drug_mas, differences = 2), type="l")

plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_orphan_drug_mas, differences = 2), type="l")
plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_orphan_drug_mas, differences = 2), type="l")

plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$annual_domestic_RD_spending_bil_dollars, differences = 2), type="l")
plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$annual_domestic_RD_spending_bil_dollars, differences = 2), type="l")
...
```{r}
plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_new_orphan_drug_mas, differences = 3), type="l")
plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_new_orphan_drug_mas, differences = 3), type="l")

plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$freq_orphan_drug_mas, differences = 3), type="l")
plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$freq_orphan_drug_mas, differences = 3), type="l")

plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "US",]$annual_domestic_RD_spending_bil_dollars, differences = 3), type="l")
plot(diff(combined_rd_ma_df[combined_rd_ma_df$area == "EU",]$annual_domestic_RD_spending_bil_dollars, differences = 3), type="l")
