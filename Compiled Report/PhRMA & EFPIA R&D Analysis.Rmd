...
A pdf can be found in the the Original Data Folder
...
ggplot(eu_od_ma_freqs, aes(x = Year)) +
  ...
  scale_color_manual(name = " ", values = c("dodgerblue", "darkred"))+
  theme_minimal()
```
...
# EU GDP (Billion USD)
https://www.macrotrends.net/global-metrics/countries/EUU/european-union/gdp-gross-domestic-product#:~:text=European%20Union%20gdp%20for%202023,a%201.99%25%20decline%20from%202019.
...
predicted <- predict(mod.pois.new.od.4, type = "response")
...
ggplot(combined_rd_ma_df, aes(x = annual_domestic_RD_spending_bil_dollars, y = freq_new_orphan_drug_mas, color = area, alpha="Observed")) +
  ...
  labs(x = "Domestic R&D Spending (Billion USD)",
       ...
       color = "Region",
       alpha = "",
       title=str_wrap(glue("Poisson Model 4 of Market Authorizations for New Orphan Drugs by Domestic R&D Spending"), width = 60))+
  scale_color_manual(name = "Region", values = c('US' = 'darkblue', 'EU' = '#E66100')) +
  geom_line(aes(x=annual_domestic_RD_spending_bil_dollars, y=predicted, alpha = "Fitted"))+
  scale_alpha_manual(values = c(0.5, 1))+
theme_minimal()
...
predicted <- predict(mod.pois.new.od.5, type = "response")
...
ggplot(combined_rd_ma_df, aes(x = annual_domestic_RD_spending_bil_dollars, y = freq_new_orphan_drug_mas, color = area, alpha="Observed")) +
  ...
  labs(x = "Domestic R&D Spending (Billion USD)",
       ...
       color = "Region",
       alpha = "",
       title=str_wrap(glue("Poisson Model 5 of Market Authorizations for New Orphan Drugs by Domestic R&D Spending"), width = 60))+
  scale_color_manual(name = "Region", values = c('US' = 'darkblue', 'EU' = '#E66100')) +
  geom_line(aes(x=annual_domestic_RD_spending_bil_dollars, y=predicted, alpha = "Fitted"))+
  scale_alpha_manual(values = c(0.5, 1))+
theme_minimal()
