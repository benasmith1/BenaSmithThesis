...
```{r}
usdtoeuroavgconversion <- read_xlsx("Cleaned Data/Area Level R&D Spending/USD to Euro Conversion Avg by Year.xlsx")
...
ggplot(eu_od_ma_freqs, aes(x = Year)) +
  ...
  scale_color_manual(name = "Legend", values = c("darkred", "dodgerblue"))+
  theme_minimal()
```
