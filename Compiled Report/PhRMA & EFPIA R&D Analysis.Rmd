...
plot(combined_rd_ma_df$year, residuals, xlab="Year", main="Model 3 Residuals", ylab="Residuals")

acf(residuals, main="ACF of Model 3 Residuals")
pacf(residuals, main="PACF of Model 3 Residuals")
...
plot(combined_rd_ma_df$year, residuals, xlab="Year", main="Model 4 Residuals", ylab="Residuals")

acf(residuals, main="ACF of Model 4 Residuals")
pacf(residuals, main="PACF of Model 4 Residuals")
kpss.test(residuals)
adf.test(residuals)
...
plot(combined_rd_ma_df$year, residuals, xlab="Year", main="Model 5 Residuals", ylab="Residuals")

acf(residuals, main="ACF of Model 5 Residuals")
pacf(residuals, main="PACF of Model 5 Residuals")
...
plot(combined_rd_ma_df$year, residuals, xlab="Year", main="Model 6 Residuals", ylab="Residuals")

acf(residuals, main="ACF of Model 6 Residuals")
pacf(residuals, main="PACF of Model 6 Residuals")
...
ggplot(combined_rd_ma_df, aes(x = yearsafter2004, y = freq_orphan_drug_mas, color = area, alpha="Observed")) +
  geom_point() +
  labs(x = "Year",
