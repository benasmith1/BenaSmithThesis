...
R&D spending grpwth rates by year
...
stargazer(rdspending_growth_rates, title="R&D Spending in USD Annual Growth Rates in the EU and US", align=TRUE, type = "html", out="Final Figures Formatted/RDSpendingAnnualGrowthRates.htm", summary = FALSE, digits=2, digit.separator="", rownames = FALSE)
```

```{r}
rdspending_growth_rates
colnames(rdspending_growth_rates) <- c("Year", "US", "EU")
```
...
combined_rd_ma_df$residuals <- resid(mod.rd.1)
par(mfrow =c(2,3))
...
plot(us_resid_data$year, us_resid_data$residuals, xlab="Year", main="Model 1 US Residuals", ylab="Residuals")
acf(us_resid_data$residuals, main="ACF of Model 1 US Residuals")
pacf(us_resid_data$residuals, main="PACF of Model 1 US Residuals")

plot(eu_resid_data$year, eu_resid_data$residuals, xlab="Year", main="Model 1 EU Residuals", ylab="Residuals")
acf(eu_resid_data$residuals, main="ACF of Model 1 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 1 EU Residuals")
mtext("Linear Model 1 of R&D Spending", side = 3, line = -1.1, outer = TRUE)
...
#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.rd.2)
par(mfrow =c(2,3))

us_resid_data <- combined_rd_ma_df[combined_rd_ma_df$area == "US",]
eu_resid_data <- combined_rd_ma_df[combined_rd_ma_df$area == "EU",]

plot(us_resid_data$year, us_resid_data$residuals, xlab="Year", main="Model 2 US Residuals", ylab="Residuals")
acf(us_resid_data$residuals, main="ACF of Model 2 US Residuals")
pacf(us_resid_data$residuals, main="PACF of Model 2 US Residuals")

plot(eu_resid_data$year, eu_resid_data$residuals, xlab="Year", main="Model 2 EU Residuals", ylab="Residuals")
acf(eu_resid_data$residuals, main="ACF of Model 2 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 2 EU Residuals")
mtext("Linear Model 2 of R&D Spending", side = 3, line = -1.1, outer = TRUE)
...
#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.rd.3)
par(mfrow =c(2,3))

us_resid_data <- combined_rd_ma_df[combined_rd_ma_df$area == "US",]
eu_resid_data <- combined_rd_ma_df[combined_rd_ma_df$area == "EU",]

plot(us_resid_data$year, us_resid_data$residuals, xlab="Year", main="Model 3 US Residuals", ylab="Residuals")
acf(us_resid_data$residuals, main="ACF of Model 3 US Residuals")
pacf(us_resid_data$residuals, main="PACF of Model 3 US Residuals")

plot(eu_resid_data$year, eu_resid_data$residuals, xlab="Year", main="Model 3 EU Residuals", ylab="Residuals")
acf(eu_resid_data$residuals, main="ACF of Model 3 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 3 EU Residuals")
mtext("Linear Model 3 of R&D Spending", side = 3, line = -1.1, outer = TRUE)
...
```{r}
predicted <- predict(mod.rd.3 , type = "response")
...
ggplot(combined_rd_ma_df, aes(x = year, y = annual_domestic_RD_spending_bil_dollars, color = area, alpha="Observed")) +
  ...
  labs(x = "Year",
       ...
       color = "Area",
       alpha = "Line Type",
       title=str_wrap("Estimated Annual Domestic R&D Spending (Billions USD) as a linear function of area and year, and area:year interaction  (Model 3)", width = 60))+
  scale_color_manual(values = colorpallate)+
...
#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.rd.4)
par(mfrow =c(2,3))

us_resid_data <- combined_rd_ma_df[combined_rd_ma_df$area == "US",]
eu_resid_data <- combined_rd_ma_df[combined_rd_ma_df$area == "EU",]

plot(us_resid_data$year, us_resid_data$residuals, xlab="Year", main="Model 4 US  Residuals", ylab="Residuals")
acf(us_resid_data$residuals, main="ACF of Model 4 US Residuals")
pacf(us_resid_data$residuals, main="PACF of Model 4 US Residuals")


plot(eu_resid_data$year, eu_resid_data$residuals, xlab="Year", main="Model 4 EU Residuals", ylab="Residuals")
acf(eu_resid_data$residuals, main="ACF of Model 4 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 4 EU Residuals")
mtext("Linear Model 4 of R&D Spending", side = 3, line = -1.1, outer = TRUE)
...
```{r}
predicted <- predict(mod.rd.4 , type = "response")
...
ggplot(combined_rd_ma_df, aes(x = year, y = annual_domestic_RD_spending_bil_dollars, color = area, alpha="Observed")) +
  ...
  labs(x = "Year",
       ...
       color = "Area",
       alpha = "Line Type",
       title=str_wrap("Estimated Annual Domestic R&D Spending (Billions USD) as a linear function of area and year, and area:year interaction, adjusted for GDP growth per capita (Model 4)", width = 60))+
  scale_color_manual(values = colorpallate)+
  geom_line(aes(x=year, y=predicted, alpha= "Fitted"))+
  scale_alpha_manual(values = c(0.5, 1))+
theme_minimal()
...
aic_values <- round(c(AIC(mod.rd.1), AIC(mod.rd.2), AIC(mod.rd.3), AIC(mod.rd.4) ))
...
stargazer(mod.rd.1, mod.rd.2, mod.rd.3, mod.rd.4, title="Models of R&D Spending (Not Adjusted for Error Structure)", align=TRUE, type = "html", out="Final Models Formatted/rdmodelsNonAdjusted.htm",
          covariate.labels = c("US (β<sub>1</sub>)", "Annual GDP Growth Rate Per Capita (β<sub>2</sub>)", "Years After 2004 (β<sub>3</sub>)", "US:Years After 2004 (β<sub>4</sub>)", "Intercept (β<sub>0</sub>)"),
...
```{r}
aic_values <- round(c(AIC(mod.rd.nw.1), AIC(mod.rd.nw.2), AIC(mod.rd.nw.3), AIC(mod.rd.nw.4) ))
...
#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.od.1)
par(mfrow =c(2,3))
...
acf(eu_resid_data$residuals, main="ACF of Model 1 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 1 EU Residuals")
mtext("Linear Model 1 of OD MAs", side = 3, line = -1.1, outer = TRUE)
...
#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.od.2)
par(mfrow =c(2,3))
...
acf(eu_resid_data$residuals, main="ACF of Model 2 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 2 EU Residuals")
mtext("Linear Model 2 of OD MAs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
mod.od.3 <- lm(freq_orphan_drug_mas ~ annual_domestic_RD_spending_bil_dollars + as.factor(area) * yearsafter2004  , data=combined_rd_ma_df)
summary(mod.od.3)

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.od.3)
par(mfrow =c(2,3))
...
acf(eu_resid_data$residuals, main="ACF of Model 3 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 3 EU Residuals")
mtext("Linear Model 3 of OD MAs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
mod.od.4 <- lm(freq_orphan_drug_mas ~ annual_domestic_RD_spending_bil_dollars + as.factor(area)*yearsafter2004 + as.factor(area)*annual_domestic_RD_spending_bil_dollars  , data=combined_rd_ma_df)
summary(mod.od.4)

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.od.4)
par(mfrow =c(2,3))
...
acf(eu_resid_data$residuals, main="ACF of Model 4 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 4 EU Residuals")
mtext("Linear Model 4 of OD MAs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
mod.od.5 <- lm(freq_orphan_drug_mas ~ annual_domestic_RD_spending_bil_dollars + as.factor(area) * yearsafter2004 + gdp_growth_rate_annual  , data=combined_rd_ma_df)
summary(mod.od.5)

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.od.5)
par(mfrow =c(2,3))

us_resid_data <- combined_rd_ma_df[combined_rd_ma_df$area == "US",]
eu_resid_data <- combined_rd_ma_df[combined_rd_ma_df$area == "EU",]

plot(us_resid_data$year, us_resid_data$residuals, xlab="Year", main="Model 5 US Residuals", ylab="Residuals")
acf(us_resid_data$residuals, main="ACF of Model 5 US Residuals")
pacf(us_resid_data$residuals, main="PACF of Model 5 US Residuals")

plot(eu_resid_data$year, eu_resid_data$residuals, xlab="Year", main="Model 5 EU Residuals", ylab="Residuals")
acf(eu_resid_data$residuals, main="ACF of Model 5 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 5 EU Residuals")
mtext("Linear Model 5 of OD MAs", side = 3, line = -1.1, outer = TRUE)
...
ggplot(combined_rd_ma_df, aes(x = year, y = freq_orphan_drug_mas, color = area, alpha="Observed")) +
  geom_point() +
  labs(x = "Year",
       y = "Number of Annual Orphan Drug Market Authorizations",
       color = "Area",
       alpha = "Line Type",
       title=str_wrap("Number of Annual Orphan Drug Market Authorizations Over Time Estimated by Linear Model 5", width = 60))+
  scale_color_manual(values = colorpallate)+
  geom_line(aes(x=year, y=predicted, alpha = "Fitted"))+
  scale_alpha_manual(values = c(0.5, 1))+
theme_minimal()
...
```{r}
mod.od.6 <- lm(freq_orphan_drug_mas ~ annual_domestic_RD_spending_bil_dollars + as.factor(area)*yearsafter2004 + gdp_growth_rate_annual + as.factor(area)*annual_domestic_RD_spending_bil_dollars , data=combined_rd_ma_df)
summary(mod.od.6)

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.od.6)
par(mfrow =c(2,3))

us_resid_data <- combined_rd_ma_df[combined_rd_ma_df$area == "US",]
eu_resid_data <- combined_rd_ma_df[combined_rd_ma_df$area == "EU",]

plot(us_resid_data$year, us_resid_data$residuals, xlab="Year", main="Model 6 US Residuals", ylab="Residuals")
acf(us_resid_data$residuals, main="ACF of Model 6 US Residuals")
pacf(us_resid_data$residuals, main="PACF of Model 6 US Residuals")

plot(eu_resid_data$year, eu_resid_data$residuals, xlab="Year", main="Model 6 EU Residuals", ylab="Residuals")
acf(eu_resid_data$residuals, main="ACF of Model 6 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 6 EU Residuals")
mtext("Linear Model 6 of OD MAs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
predicted <- predict(mod.od.6 , type = "response")
...
ggplot(combined_rd_ma_df, aes(x = year, y = freq_orphan_drug_mas, color = area, alpha="Observed")) +
  ...
  labs(x = "Year",
       ...
       color = "Area",
       alpha = "Line Type",
       title=str_wrap("Number of Annual Orphan Drug Market Authorizations Over Time Estimated by Linear Model 6", width = 60))+
  scale_color_manual(values = colorpallate)+
  geom_line(aes(x=year, y=predicted, alpha = "Fitted"))+
  scale_alpha_manual(values = c(0.5, 1))+
theme_minimal()
...
```{r}
aic_values <- round(c(AIC(mod.od.1), AIC(mod.od.2), AIC(mod.od.3), AIC(mod.od.4), AIC(mod.od.5), AIC(mod.od.6) ))

stargazer(mod.od.1, mod.od.2, mod.od.3, mod.od.4, mod.od.5, mod.od.6, title="Models of Orphan Drug Market Authorizations (Not Adjusted for Error Structure)", align=TRUE, type = "html", out="Final Models Formatted/orphandrugMAmodelsNonAdjusted.htm",
          covariate.labels = c("Annual Domestic R&D Spending (Billions USD)", "US", "Years After 2004",  "Annual GDP Growth Rate Per Capita", "Years After 2004:US", "Annual Domestic R&D Spending (Billions USD):US" , "Intercept"),
...
aic_values <- round(c(AIC(m1), AIC(m2), AIC(m3), AIC(m4), AIC(m5), AIC(m6) ))


stargazer(m1,m2,m3,m4,m5,m6, title="Newey-West Adjusted Models of Orphan Drug Market Authorizations", align=TRUE, type = "html", out="Final Models Formatted/orphandrugMAmodels.htm",
          covariate.labels = c("Annual Domestic R&D Spending (Billions USD)", "US", "Years After 2004",  "Annual GDP Growth Rate Per Capita", "Years After 2004:US", "Annual Domestic R&D Spending (Billions USD):US" , "Intercept"),
          dep.var.labels=c("Annual Number of Market Authorized Orphan Drugs"),
          add.lines = list(c("AIC", aic_values))
          )
...
#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.new.od.1)
...
acf(eu_resid_data$residuals, main="ACF of Model 1 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 1 EU Residuals")
mtext("Linear Model 1 of MAs for NEW ODs", side = 3, line = -1.1, outer = TRUE)
...
#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.new.od.2)
...
acf(eu_resid_data$residuals, main="ACF of Model 2 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 2 EU Residuals")
mtext("Linear Model 2 of MAs for NEW ODs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
mod.new.od.3 <- lm(freq_new_orphan_drug_mas ~ annual_domestic_RD_spending_bil_dollars + as.factor(area) * yearsafter2004  , data=combined_rd_ma_df)
summary(mod.new.od.3)

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.new.od.3)
...
acf(eu_resid_data$residuals, main="ACF of Model 3 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 3 EU Residuals")
mtext("Linear Model 3 of MAs for NEW ODs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
mod.new.od.4 <- lm(freq_new_orphan_drug_mas ~ annual_domestic_RD_spending_bil_dollars + as.factor(area)*yearsafter2004 + as.factor(area)*annual_domestic_RD_spending_bil_dollars  , data=combined_rd_ma_df)
summary(mod.new.od.4)

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.new.od.4)
...
acf(eu_resid_data$residuals, main="ACF of Model 4 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 4 EU Residuals")
mtext("Linear Model 4 of MAs for NEW ODs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
mod.new.od.5 <- lm(freq_new_orphan_drug_mas ~ annual_domestic_RD_spending_bil_dollars + as.factor(area) * yearsafter2004 + gdp_growth_rate_annual  , data=combined_rd_ma_df)
summary(mod.new.od.5)

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.new.od.5)
...
acf(eu_resid_data$residuals, main="ACF of Model 5 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 5 EU Residuals")
mtext("Linear Model 5 of MAs for NEW ODs", side = 3, line = -1.1, outer = TRUE)
...
ggplot(combined_rd_ma_df, aes(x = year, y = freq_orphan_drug_mas, color = area, alpha="Observed")) +
  ...
  labs(x = "Year",
       ...
       color = "Area",
       alpha = "Line Type",
       title=str_wrap("Number of Annual Market Authorizations for NEW Orphan Drugs Over Time Estimated by Linear Model 5", width = 60))+
  scale_color_manual(values = colorpallate)+
  geom_line(aes(x=year, y=predicted, alpha = "Fitted"))+
  scale_alpha_manual(values = c(0.5, 1))+
theme_minimal()
...
```{r}
mod.new.od.6 <- lm(freq_new_orphan_drug_mas ~ annual_domestic_RD_spending_bil_dollars + as.factor(area)*yearsafter2004 + gdp_growth_rate_annual + as.factor(area)*annual_domestic_RD_spending_bil_dollars , data=combined_rd_ma_df)
summary(mod.new.od.6)

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.new.od.6)
...
acf(eu_resid_data$residuals, main="ACF of Model 6 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 6 EU Residuals")
mtext("Linear Model 6 of MAs for NEW ODs", side = 3, line = -1.1, outer = TRUE)
...
stargazer(m1, m2, m3, m4, m5, m6, title="Models of Market Authorizations for NEW Orphan Drugs (Not adjusted for Error Structure)", align=TRUE, type = "html", out="Final Models Formatted/NEWorphandrugMAmodelsNonAdjusted.htm",
          covariate.labels = c("Annual Domestic R&D Spending (Billions USD)", "US", "Years After 2004",  "Annual GDP Growth Rate Per Capita", "Years After 2004:US", "Annual Domestic R&D Spending (Billions USD):US" , "Intercept"),
...
stargazer(m1, m2, m3, m4, m5, m6, title="Newey-West Adjusted Models of Market Authorizations for NEW Orphan Drugs", align=TRUE, type = "html", out="Final Models Formatted/NEWorphandrugMAmodels.htm",
          covariate.labels = c("Annual Domestic R&D Spending (Billions USD)", "US", "Years After 2004",  "Annual GDP Growth Rate Per Capita", "Years After 2004:US", "Annual Domestic R&D Spending (Billions USD):US" , "Intercept"),
          dep.var.labels=c("Annual Number of Market Authorizations for New Orphan Drugs"),
          add.lines = list(c("AIC", aic_values)))
```
...
## Poisson Model of Freq of orphan drug mas by US over time - no interaction

```{r}
mod.pois.od.1 <- glm(freq_orphan_drug_mas ~ as.factor(area) + yearsafter2004  , data=combined_rd_ma_df, family=poisson(link="log"))

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.pois.od.1)
...
acf(eu_resid_data$residuals, main="ACF of Model 1 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 1 EU Residuals")
mtext("Poisson Model 1 of Orphan Drug MAs", side = 3, line = -1.1, outer = TRUE)
...
#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.pois.od.2)
...
acf(eu_resid_data$residuals, main="ACF of Model 2 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 2 EU Residuals")
mtext("Poisson Model 2 of Orphan Drug MAs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
predicted <- predict(mod.pois.od.2 , type = "response")
...
ggplot(combined_rd_ma_df, aes(x = year, y = freq_orphan_drug_mas, color = area, alpha="Observed")) +
  ...
  labs(x = "Year",
       ...
       color = "Area",
       alpha = "Line Type",
       title=str_wrap("Number of Annual Orphan Drug Market Authorizations Over Time Estimated by Poisson Model 2", width = 60))+
  scale_color_manual(values = colorpallate)+
  geom_line(aes(x=year, y=predicted, alpha = "Fitted"))+
  scale_alpha_manual(values = c(0.5, 1))+
theme_minimal()
...
```{r}
mod.pois.od.3 <- glm(freq_orphan_drug_mas ~ annual_domestic_RD_spending_bil_dollars + as.factor(area) * yearsafter2004  , data=combined_rd_ma_df , family=poisson(link="log"))
summary(mod.pois.od.3)

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.pois.od.3)
...
acf(eu_resid_data$residuals, main="ACF of Model 3 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 3 EU Residuals")
mtext("Poisson Model 3 of Orphan Drug MAs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
mod.pois.od.4 <- glm(freq_orphan_drug_mas ~ annual_domestic_RD_spending_bil_dollars + as.factor(area)*yearsafter2004 + as.factor(area)*annual_domestic_RD_spending_bil_dollars  , data=combined_rd_ma_df, family=poisson(link="log")) 
summary(mod.pois.od.4)

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.pois.od.4)
...
acf(eu_resid_data$residuals, main="ACF of Model 4 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 4 EU Residuals")
mtext("Poisson Model 4 of Orphan Drug MAs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
mod.pois.od.5 <- glm(freq_orphan_drug_mas ~ annual_domestic_RD_spending_bil_dollars + as.factor(area) * yearsafter2004 + gdp_growth_rate_annual  , data=combined_rd_ma_df, family=poisson(link="log")) 
summary(mod.pois.od.5)

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.pois.od.5)
...
acf(eu_resid_data$residuals, main="ACF of Model 5 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 5 EU Residuals")
mtext("Poisson Model 5 of Orphan Drug MAs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
predicted <- predict(mod.pois.od.5 , type = "response")
...
ggplot(combined_rd_ma_df, aes(x = year, y = freq_orphan_drug_mas, color = area, alpha="Observed")) +
  ...
  labs(x = "Year",
       ...
       color = "Area",
       alpha = "Line Type",
       title=str_wrap("Number of Annual Orphan Drug Market Authorizations Over Time Estimated by Poisson Model 5", width = 60))+
  scale_color_manual(values = colorpallate)+
  geom_line(aes(x=year, y=predicted, alpha = "Fitted"))+
  scale_alpha_manual(values = c(0.5, 1))+
theme_minimal()
...
```{r}
mod.pois.od.6 <- glm(freq_orphan_drug_mas ~ annual_domestic_RD_spending_bil_dollars + as.factor(area)*yearsafter2004 + gdp_growth_rate_annual + as.factor(area)*annual_domestic_RD_spending_bil_dollars , data=combined_rd_ma_df, family=poisson(link="log")) 
summary(mod.pois.od.6)

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.pois.od.6)
...
acf(eu_resid_data$residuals, main="ACF of Model 6 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 6 EU Residuals")
mtext("Poisson Model 6 of Orphan Drug MAs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
predicted <- predict(mod.pois.od.6 , type = "response")
...
ggplot(combined_rd_ma_df, aes(x = year, y = freq_orphan_drug_mas, color = area, alpha="Observed")) +
  ...
  labs(x = "Year",
       ...
       color = "Area",
       alpha = "Line Type",
       title=str_wrap("Number of Annual Orphan Drug Market Authorizations Over Time Estimated by Poisson Model 6", width = 60))+
  scale_color_manual(values = colorpallate)+
  geom_line(aes(x=year, y=predicted, alpha = "Fitted"))+
  scale_alpha_manual(values = c(0.5, 1))+
theme_minimal()
...
stargazer(m1, m2, m3, m4, m5, m6, title="Poisson Models of Orphan Drug Market Authorizations (Not adjusted for Error Structure)", align=TRUE, type = "html", out="Final Models Formatted/PoissonorphandrugMAmodelsNonAdjusted.htm",
          covariate.labels = c("Annual Domestic R&D Spending (Billions USD)", "US", "Years After 2004",  "Annual GDP Growth Rate Per Capita", "Years After 2004:US", "Annual Domestic R&D Spending (Billions USD):US" , "Intercept"),
          dep.var.labels=c("Annual Number of Market Authorized Orphan Drugs")
          )
```
...
stargazer(m1,m2,m3,m4,m5,m6, title="Newey-West Adjusted Poisson Models of Orphan Drug Market Authorizations", align=TRUE, type = "html", out="Final Models Formatted/PoissonorphandrugMAmodels.htm",
          covariate.labels = c("Annual Domestic R&D Spending (Billions USD)", "US", "Years After 2004",  "Annual GDP Growth Rate Per Capita", "Years After 2004:US", "Annual Domestic R&D Spending (Billions USD):US" , "Intercept"),
          dep.var.labels=c("Annual Number of Market Authorized Orphan Drugs"),
          add.lines = list(c("AIC", aic_values))
...
#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.pois.new.od.1)
...
acf(eu_resid_data$residuals, main="ACF of Model 1 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 1 EU Residuals")
mtext("Poisson Model 1 of MAs for NEW Orphan Drugs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
predicted <- predict(mod.pois.new.od.1 , type = "response")
...
ggplot(combined_rd_ma_df, aes(x = year, y = freq_orphan_drug_mas, color = area, alpha="Observed")) +
  ...
  labs(x = "Year",
       ...
       color = "Area",
       alpha = "Line Type",
       title=str_wrap("Number of Annual Market Authorizations for NEW Orphan Drugs Over Time Estimated by Poisson Model 1", width = 60))+
  scale_color_manual(values = colorpallate)+
  geom_line(aes(x=year, y=predicted, alpha = "Fitted"))+
  scale_alpha_manual(values = c(0.5, 1))+
theme_minimal()
...
#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.pois.new.od.2)
...
acf(eu_resid_data$residuals, main="ACF of Model 2 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 2 EU Residuals")
mtext("Poisson Model 2 of MAs for NEW Orphan Drugs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
mod.pois.new.od.3 <- glm(freq_new_orphan_drug_mas ~ annual_domestic_RD_spending_bil_dollars + as.factor(area) * yearsafter2004  , data=combined_rd_ma_df , family=poisson(link="log"))
summary(mod.pois.new.od.3)

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.pois.new.od.3)
...
acf(eu_resid_data$residuals, main="ACF of Model 3 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 3 EU Residuals")
mtext("Poisson Model 3 of MAs for NEW Orphan Drugs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
mod.pois.new.od.4 <- glm(freq_new_orphan_drug_mas ~ annual_domestic_RD_spending_bil_dollars + as.factor(area)*yearsafter2004 + as.factor(area)*annual_domestic_RD_spending_bil_dollars  , data=combined_rd_ma_df, family=poisson(link="log")) 
summary(mod.pois.new.od.4)

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.pois.new.od.4)
...
acf(eu_resid_data$residuals, main="ACF of Model 4 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 4 EU Residuals")
mtext("Poisson Model 4 of MAs for NEW Orphan Drugs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
mod.pois.new.od.5 <- glm(freq_new_orphan_drug_mas ~ annual_domestic_RD_spending_bil_dollars + as.factor(area) * yearsafter2004 + gdp_growth_rate_annual  , data=combined_rd_ma_df, family=poisson(link="log")) 
summary(mod.pois.new.od.5)

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.pois.new.od.5)
...
acf(eu_resid_data$residuals, main="ACF of Model 5 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 5 EU Residuals")
mtext("Poisson Model 5 of MAs for NEW Orphan Drugs", side = 3, line = -1.1, outer = TRUE)
...
```{r}
mod.pois.new.od.6 <- glm(freq_new_orphan_drug_mas ~ annual_domestic_RD_spending_bil_dollars + as.factor(area)*yearsafter2004 + gdp_growth_rate_annual + as.factor(area)*annual_domestic_RD_spending_bil_dollars , data=combined_rd_ma_df, family=poisson(link="log")) 
summary(mod.pois.new.od.6)

#Plot residuals and acf/ pacf of residuals by panel (EU/US)
combined_rd_ma_df$residuals <- resid(mod.pois.new.od.6)
...
acf(eu_resid_data$residuals, main="ACF of Model 6 EU Residuals")
pacf(eu_resid_data$residuals, main="PACF of Model 6 EU Residuals")
mtext("Poisson Model 6 of MAs for NEW Orphan Drugs", side = 3, line = -1.1, outer = TRUE)
...
stargazer(m1, m2, m3, m4, m5, m6, title="Poisson Models of Market Authorizations for NEW Orphan Drugs (Not adjusted for Error Structure)", align=TRUE, type = "html", out="Final Models Formatted/PoissonNEWorphandrugMAmodelsNonAdjusted.htm",
          covariate.labels = c("Annual Domestic R&D Spending (Billions USD)", "US", "Years After 2004",  "Annual GDP Growth Rate Per Capita", "Years After 2004:US", "Annual Domestic R&D Spending (Billions USD):US" , "Intercept"),
          dep.var.labels=c("Annual Number of Market Authorizations for NEW Orphan Drugs")
          )
```
...
stargazer(m1,m2,m3,m4,m5,m6, title="Newey-West Adjusted Poisson Models of Market Authorizations for NEW Orphan Drugs ", align=TRUE, type = "html", out="Final Models Formatted/PoissonNEWorphandrugMAmodels.htm",
          covariate.labels = c("Annual Domestic R&D Spending (Billions USD)", "US", "Years After 2004",  "Annual GDP Growth Rate Per Capita", "Years After 2004:US", "Annual Domestic R&D Spending (Billions USD):US" , "Intercept"),
          dep.var.labels=c("Annual Number of Market Authorizations for NEW Orphan Drugs"),
          add.lines = list(c("AIC", aic_values))
          )
